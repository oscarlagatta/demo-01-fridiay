      ...
      <CardContent className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div
              className={`flex items-center space-x-2 px-3 py-1 rounded-full border ${getBadgeStyles(performance.color)}`}
            >
          ...
          <div className="text-xs font-medium opacity-75 capitalize">{performance.status} Performance</div>
        </div>

        <div className="mt-2 text-xs opacity-60">View individual section timing in the flow diagram headers above</div>
      </CardContent>
    </Card>
  )
}
